...
micapipe \
     ...
     -dwi_phase ${bids}/${sub}/${ses}/dwi/${sub}_${ses}_acq-multib38_dir-AP_part-phase_dwi.nii.gz,${bids}/${sub}/${ses}/dwi/${sub}_${ses}_acq-multib70_dir-AP_part-phase_dwi.nii.gz \
 #${bids}/sub-${sub}/ses-${ses}/dwi/sub-${sub}_ses-${ses}_acq_multib_38d_dir-AP_part-phase_dwi.nii.gz,${bids}/sub-${sub}/ses-${ses}/dwi/sub-${sub}_ses-${ses}_acq_multib_70d_dir-AP_part-phase_dwi.nii.gz
#
#
# DWI processing
# micapipe \
